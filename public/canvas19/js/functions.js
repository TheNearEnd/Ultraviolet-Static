				...
				$flexSliderEl.each(function() {
					...
					$flexsSlider.flexslider({
						...
						start: function(slider){
							...
							SEMICOLON.initialize.lightbox();
							$('.flex-prev').html('<i class="icon-angle-left"><span class="sr-only">Previous Slide</span></i>');
							$('.flex-next').html('<i class="icon-angle-right"><span class="sr-only">Next Slide</span></i>');
